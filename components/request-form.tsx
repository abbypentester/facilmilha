...
export function RequestForm() {
  ...
  return (
    <Card className="shadow-2xl border-0 bg-white ring-1 ring-gray-100 overflow-hidden">
      ...
      <CardHeader className="space-y-1 pb-4 md:pb-6">
        ...
        <CardDescription className="text-sm md:text-base text-gray-500">
            Preencha os dados abaixo para receber ofertas de milheiros.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4 md:space-y-6">
        <form action={async (formData) => { await createFlightRequest(formData) }} className="space-y-6">
          ...
          <div className="flex p-1 bg-gray-100 rounded-xl mb-6">
            <button 
                ...
                className={`flex-1 py-2.5 text-base md:text-sm font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2 ${tripType === 'ONE_WAY' ? 'bg-white shadow-sm text-blue-600 ring-1 ring-black/5' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200/50'}`}
            >
            ...
            <button 
                ...
                className={`flex-1 py-2.5 text-base md:text-sm font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2 ${tripType === 'ROUND_TRIP' ? 'bg-white shadow-sm text-blue-600 ring-1 ring-black/5' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200/50'}`}
            >
                <ArrowRightLeft className="w-4 h-4" /> Ida e Volta
            </button>
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    <select 
                        ...
                        className="flex h-11 w-full items-center justify-between rounded-lg border border-gray-200 bg-white px-3 py-2 text-base md:text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 disabled:cursor-not-allowed disabled:opacity-50 appearance-none"
                    >
